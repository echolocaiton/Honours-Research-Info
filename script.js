// Mobile nav toggle
  ...
  if(platformDemo && platformVideoSrc){
    platformDemo.innerHTML = `<video controls playsinline muted preload="metadata" aria-label="Interactive anatomy platform screen recording"><source src="${platformVideoSrc}" type="video/mp4">Your browser does not support embedded video.</video>`;
  }
